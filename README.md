...
Análise de vários conjuntos de dados do setor de energia.

Processamento de dados feito pelo Orange.

## Dataset 1 — Appliances Energy Prediction (UCI)
Fonte: https://archive.ics.uci.edu/dataset/374/appliances+energy+prediction
Processamento: <img width="634" height="392" alt="image" src="https://github.com/user-attachments/assets/c6d87bb6-a9c5-4829-a887-0891cd7cb31c" />
...
Processamento: <img width="708" height="438" alt="image" src="https://github.com/user-attachments/assets/c009ed53-8d6d-46f1-bf46-6ac7f8bed77d" />
...
Processamento: <img width="523" height="324" alt="image" src="https://github.com/user-attachments/assets/96ba4a3d-1b49-480b-b4ee-91b6857f110c" />

## Dataset 4 — Solar Power Generation Data (Kaggle)
Fonte: https://www.kaggle.com/datasets/anikannal/solar-power-generation-data
Processamento: <img width="505" height="312" alt="image" src="https://github.com/user-attachments/assets/1bc28b6e-4085-456d-90a1-df3e7a7aa51d" />
...
Processamento: <img width="597" height="370" alt="image" src="https://github.com/user-attachments/assets/0124c764-3aed-446d-8890-eaf6ed5ed5bd" />
